...
/**
 * ezsigndocumentGetFormDataV1 - parameters interface
 */
export interface IEzsigndocumentGetFormDataV1Params {
  pkiEzsigndocumentID: number;
}
...
/**
 * ezsigndocumentGetWordsPositionsV1 - parameters interface
 */
export interface IEzsigndocumentGetWordsPositionsV1Params {
  pkiEzsigndocumentID: number;
...
export class ObjectEzsigndocumentApi extends Api {
  ...
  async ezsigndocumentGetFormDataV1(params: IEzsigndocumentGetFormDataV1Params): Promise<any> {
    // Verify required parameters are set
    this.ensureParamIsSet('ezsigndocumentGetFormDataV1', params, 'pkiEzsigndocumentID');

    // Create URL to call
    const url = `${this.basePath}/1/object/ezsigndocument/{pkiEzsigndocumentID}/getFormData`
      .replace(`{${'pkiEzsigndocumentID'}}`, encodeURIComponent(`${params['pkiEzsigndocumentID']}`));
  ...
  async ezsigndocumentGetWordsPositionsV1(params: IEzsigndocumentGetWordsPositionsV1Params): Promise<EzsigndocumentGetWordsPositionsV1Response> {
    // Verify required parameters are set
    this.ensureParamIsSet('ezsigndocumentGetWordsPositionsV1', params, 'pkiEzsigndocumentID');
    this.ensureParamIsSet('ezsigndocumentGetWordsPositionsV1', params, 'ezsigndocumentGetWordsPositionsV1Request');

    // Create URL to call
    const url = `${this.basePath}/1/object/ezsigndocument/{pkiEzsigndocumentID}/getWordsPositions`
      .replace(`{${'pkiEzsigndocumentID'}}`, encodeURIComponent(`${params['pkiEzsigndocumentID']}`));
    ...
    const response = await this.httpClient.createRequest(url)
      ...
      // Encode body parameter
      .withHeader('content-type', 'application/json')
      .withContent(JSON.stringify(params['ezsigndocumentGetWordsPositionsV1Request'] || {}))
